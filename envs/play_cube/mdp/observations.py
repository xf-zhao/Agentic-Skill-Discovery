...
def drawer_joint_pos_rel(env: BaseEnv, asset_cfg: SceneEntityCfg = SceneEntityCfg("cabinet"), selected_joints: tuple[str,]=('drawer_handle_top_joint')) -> torch.Tensor:
    """The joint positions of the asset w.r.t. the default joint positions."""
    # extract the used quantities (to enable type-hinting)
    asset: Articulation = env.scene[asset_cfg.name]
    drawer_joint_pos_rel = asset.data.joint_pos[:, -1] - asset.data.default_joint_pos[:, -1]
